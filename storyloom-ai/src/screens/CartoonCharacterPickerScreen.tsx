...
export default function CartoonCharacterPickerScreen() {
  ...
  function handleContinue() {
    ...
    navigation.navigate('LoadingScene', {
      ...
      main_gender:     main.gender,
      secondary_name:  secondary.displayName,
      secondary_emoji: secondary.emoji,
      secondary_gender: secondary.gender,
    } as any);
    // Actually navigate to CharacterUpload with pre-filled data
...
const styles = StyleSheet.create({
  ...
  tab:         { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20, backgroundColor: colors.bgCard, borderWidth: 1, borderColor: colors.border },
  tabActive:   { backgroundColor: colors.plumbob, borderColor: colors.plumbob },
  tabText:     { fontSize: 10, fontWeight: '700', color: colors.textMuted, letterSpacing: 0.5 },
  tabTextActive: { color: '#fff' },

  searchRow:   { flexDirection: 'row', alignItems: 'center', marginHorizontal: 16, marginTop: 10, backgroundColor: colors.bgCard, borderRadius: 12, borderWidth: 1, borderColor: colors.border, paddingHorizontal: 12 },
  ...
  charCard:    { borderRadius: 12, backgroundColor: colors.bgCard, borderWidth: 1, borderColor: colors.border, alignItems: 'center', justifyContent: 'center', gap: 4, margin: 2 },
  charCardMain: { borderColor: colors.plumbob, backgroundColor: colors.plumbobGlow },
  charCardSec:  { borderColor: colors.purple, backgroundColor: colors.purpleGlow },
  charEmoji:    {},
  charName:     { fontSize: 9, color: colors.textSecondary, fontWeight: '600', textAlign: 'center', paddingHorizontal: 4 },
  ...
  checkBadgeSec: { backgroundColor: colors.purple },
  checkText:    { fontSize: 7, color: '#fff', fontWeight: '800' },
  ...
  slot:        { flex: 1, backgroundColor: colors.bgCard, borderRadius: 14, borderWidth: 1, borderColor: colors.border, padding: 12, minHeight: 110 },
  ...
  slotClear:   { color: colors.textMuted, fontSize: 14 },
  ...
  genderPill:  { flex: 1, paddingVertical: 4, borderRadius: 8, backgroundColor: colors.bgSurface, alignItems: 'center', borderWidth: 1, borderColor: colors.border },
  genderPillActive: { backgroundColor: colors.plumbob, borderColor: colors.plumbob },
  genderText:  { fontSize: 9, color: colors.textMuted, fontWeight: '600' },
  ...
  continueBtn: { backgroundColor: colors.plumbob, borderRadius: 14, paddingVertical: 16, alignItems: 'center', shadowColor: colors.plumbob, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.4, shadowRadius: 12, elevation: 6 },
  continueBtnDisabled: { backgroundColor: colors.bgCard, shadowOpacity: 0 },
